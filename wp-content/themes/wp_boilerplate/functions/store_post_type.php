...
if ( ! function_exists('tienda_post_type') ) {

// Register Custom Post Type
function tienda_post_type() {

	$labels = array(
		'name'                  => _x( 'Productos', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Producto', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Tienda', 'text_domain' ),
		'name_admin_bar'        => __( 'Tienda', 'text_domain' ),
...
add_action( 'init', 'tienda_post_type', 0 );
